...
export function createSupervisorAction(payload) {
  ...
  return async (dispatch) => {
    ...
    const url = "http://localhost:8090/api/supervisor/create";
...
export function updateSupervisorAction(payload) {
  ...
  return async (dispatch) => {
    // WE HV TO CALL THE SPRINT1 / SPRING BOOT
    const url = `http://localhost:8090/api/supervisor/${payload.supervisorId}`;
    const requestBody = { ...payload };
...
export function getAllSupervisorAction(payload) {
  ...
  return async (dispatch) => {
    // WE HV TO CALL THE SPRINT1 / SPRING BOOT
    const url = "http://localhost:8090/api/supervisor/";
